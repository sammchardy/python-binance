...
<PyAttribute name={"connection_lock"} type={"asyncio.Lock"} value={null} />

## Functions

<PyFunction name={"__init__"} type={"(self, url, tld='com', testnet=False, https_proxy=None)"}>
...
<PyFunction name={"register_subscription_queue"} type={"(self, subscription_id, queue) -> None"}>
...
<PyParameter name={"self"} type={null} value={null} />
<PyParameter name={"subscription_id"} type={"str"} value={null} />
<PyParameter name={"queue"} type={"asyncio.Queue"} value={null} />
...
<PyFunction name={"unregister_subscription_queue"} type={"(self, subscription_id) -> None"}>
