...
####################################################
    ...
    async def v3_get_ui_klines(self, **params):
        return await self._request_api("get", "uiKlines", signed=True, data=params, version="v3")
    ...
    async def v3_get_acccount(self, **params):
        return await self._request_api("get", "acccount", signed=True, data=params, version="v3")
    ...
    async def v3_get_ticker_trading_day(self, **params):
        return await self._request_api("get", "ticker/tradingDay", signed=True, data=params, version="v3")
    ...
    async def v3_post_order_oco(self, **params):
        return await self._request_api("post", "order/oco", signed=True, data=params, version="v3")
