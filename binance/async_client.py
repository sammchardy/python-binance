...
class AsyncClient(BaseClient):
    ...
    async def _request(
        ...
        if (
            ...
            signature = dict_data.get("signature", None)
            if signature:
    ...
    async def get_symbol_info(self, symbol) -> dict | None:
    ...
    async def get_all_tickers(self, symbol: str | None = None) -> list[dict[str, str]]:
        params = {}
        if symbol:
    ...
    async def get_deposit_address(
        self, coin: str, network: str | None = None, **params
    ):
        params["coin"] = coin
        if network:
    ...
    get_margin_force_liquidation_rec.__doc__ = (
        Client.get_margin_force_liquidation_rec.__doc__
    )
    ...
    async def margin_create_listen_token(
        self,
    ...
    isolated_margin_stream_get_listen_key.__doc__ = (
        Client.isolated_margin_stream_get_listen_key.__doc__
    )
    ...
    isolated_margin_stream_keepalive.__doc__ = (
        Client.isolated_margin_stream_keepalive.__doc__
    )
    ...
    get_fixed_activity_project_list.__doc__ = (
        Client.get_fixed_activity_project_list.__doc__
    )
    ...
    change_fixed_activity_to_daily_position.__doc__ = (
        Client.change_fixed_activity_to_daily_position.__doc__
    )
    ...
    get_sub_account_transfer_history.__doc__ = (
        Client.get_sub_account_transfer_history.__doc__
    )
    ...
    get_sub_account_futures_transfer_history.__doc__ = (
        Client.get_sub_account_futures_transfer_history.__doc__
    )
    ...
    create_sub_account_futures_transfer.__doc__ = (
        Client.create_sub_account_futures_transfer.__doc__
    )
    ...
    get_subaccount_deposit_address.__doc__ = (
        Client.get_subaccount_deposit_address.__doc__
    )
    ...
    get_subaccount_deposit_history.__doc__ = (
        Client.get_subaccount_deposit_history.__doc__
    )
    ...
    get_subaccount_futures_margin_status.__doc__ = (
        Client.get_subaccount_futures_margin_status.__doc__
    )
    ...
    get_subaccount_futures_details.__doc__ = (
        Client.get_subaccount_futures_details.__doc__
    )
    ...
    get_subaccount_futures_summary.__doc__ = (
        Client.get_subaccount_futures_summary.__doc__
    )
    ...
    get_subaccount_futures_positionrisk.__doc__ = (
        Client.get_subaccount_futures_positionrisk.__doc__
    )
    ...
    make_subaccount_futures_transfer.__doc__ = (
        Client.make_subaccount_futures_transfer.__doc__
    )
    ...
    make_subaccount_margin_transfer.__doc__ = (
        Client.make_subaccount_margin_transfer.__doc__
    )
    ...
    make_subaccount_to_subaccount_transfer.__doc__ = (
        Client.make_subaccount_to_subaccount_transfer.__doc__
    )
    ...
    make_subaccount_to_master_transfer.__doc__ = (
        Client.make_subaccount_to_master_transfer.__doc__
    )
    ...
    get_subaccount_transfer_history.__doc__ = (
        Client.get_subaccount_transfer_history.__doc__
    )
    ...
    make_subaccount_universal_transfer.__doc__ = (
        Client.make_subaccount_universal_transfer.__doc__
    )
    ...
    get_universal_transfer_history.__doc__ = (
        Client.get_universal_transfer_history.__doc__
    )
    ...
    futures_historical_klines_generator.__doc__ = (
        Client.futures_historical_klines_generator.__doc__
    )
    ...
    futures_top_longshort_account_ratio.__doc__ = (
        Client.futures_top_longshort_account_ratio.__doc__
    )
    ...
    futures_top_longshort_position_ratio.__doc__ = (
        Client.futures_top_longshort_position_ratio.__doc__
    )
    ...
    futures_global_longshort_ratio.__doc__ = (
        Client.futures_global_longshort_ratio.__doc__
    )
    ...
    async def futures_symbol_ticker(self, **params):
        return await self._request_futures_api(
            "get", "ticker/price", version=2, data=params
        )
    ...
    futures_cross_collateral_adjust_history.__doc__ = (
        Client.futures_cross_collateral_adjust_history.__doc__
    )
    ...
    futures_cross_collateral_liquidation_history.__doc__ = (
    ...
    async def futures_get_order(self, **params):
        ...
        if is_conditional:
            return await self._request_futures_api(
                "get", "algoOrder", True, data=params
            )
        else:
    ...
    async def futures_get_open_orders(self, **params):
        ...
        if is_conditional:
            return await self._request_futures_api(
                "get", "openAlgoOrders", True, data=params
            )
        else:
            return await self._request_futures_api(
    ...
    async def futures_get_all_orders(self, **params):
        ...
        if is_conditional:
            return await self._request_futures_api(
                "get", "allAlgoOrders", True, data=params
            )
        else:
            return await self._request_futures_api(
                "get", "allOrders", True, data=params
            )
    ...
    async def futures_cancel_order(self, **params):
        ...
        if is_conditional:
            return await self._request_futures_api(
                "delete", "algoOrder", True, data=params
            )
        else:
    ...
    futures_cancel_all_open_orders.__doc__ = (
        Client.futures_cancel_all_open_orders.__doc__
    )
    ...
    futures_cancel_all_algo_open_orders.__doc__ = (
        Client.futures_cancel_all_algo_open_orders.__doc__
    )
    ...
    async def futures_symbol_adl_risk(self, **params):
        return await self._request_futures_api(
            "get", "symbolAdlRisk", True, data=params
        )
    ...
    futures_change_position_margin.__doc__ = (
        Client.futures_change_position_margin.__doc__
    )
    ...
    futures_position_margin_history.__doc__ = (
        Client.futures_position_margin_history.__doc__
    )
    ...
    futures_change_multi_assets_mode.__doc__ = (
        Client.futures_change_multi_assets_mode.__doc__
    )
    ...
    futures_coin_historical_trades.__doc__ = (
        Client.futures_coin_historical_trades.__doc__
    )
    ...
    futures_coin_index_price_klines.__doc__ = (
        Client.futures_coin_index_price_klines.__doc__
    )
    ...
    futures_coin_liquidation_orders.__doc__ = (
        Client.futures_coin_liquidation_orders.__doc__
    )
    ...
    futures_coin_open_interest_hist.__doc__ = (
        Client.futures_coin_open_interest_hist.__doc__
    )
    ...
    futures_coin_place_batch_order.__doc__ = (
        Client.futures_coin_place_batch_order.__doc__
    )
    ...
    futures_coin_cancel_all_open_orders.__doc__ = (
        Client.futures_coin_cancel_all_open_orders.__doc__
    )
    ...
    futures_coin_change_margin_type.__doc__ = (
        Client.futures_coin_change_margin_type.__doc__
    )
    ...
    futures_coin_change_position_margin.__doc__ = (
        Client.futures_coin_change_position_margin.__doc__
    )
    ...
    futures_coin_position_margin_history.__doc__ = (
        Client.futures_coin_position_margin_history.__doc__
    )
    ...
    futures_coin_position_information.__doc__ = (
        Client.futures_coin_position_information.__doc__
    )
    ...
    futures_coin_change_position_mode.__doc__ = (
        Client.futures_coin_change_position_mode.__doc__
    )
    ...
    futures_coin_get_position_mode.__doc__ = (
        Client.futures_coin_get_position_mode.__doc__
    )
    ...
    futures_coin_stream_get_listen_key.__doc__ = (
        Client.futures_coin_stream_get_listen_key.__doc__
    )
    ...
    get_fiat_deposit_withdraw_history.__doc__ = (
        Client.get_fiat_deposit_withdraw_history.__doc__
    )
    ...
    papi_get_margin_max_borrowable.__doc__ = (
        Client.papi_get_margin_max_borrowable.__doc__
    )
    ...
    papi_change_um_position_side_dual.__doc__ = (
        Client.papi_change_um_position_side_dual.__doc__
    )
    ...
    papi_get_um_position_side_dual.__doc__ = (
        Client.papi_get_um_position_side_dual.__doc__
    )
    ...
    papi_get_cm_position_side_dual.__doc__ = (
        Client.papi_get_cm_position_side_dual.__doc__
    )
    ...
    papi_get_um_api_trading_status.__doc__ = (
        Client.papi_get_um_api_trading_status.__doc__
    )
    ...
    papi_get_margin_interest_history.__doc__ = (
        Client.papi_get_margin_interest_history.__doc__
    )
    ...
    papi_repay_futures_negative_balance.__doc__ = (
        Client.papi_repay_futures_negative_balance.__doc__
    )
    ...
    papi_get_portfolio_interest_history.__doc__ = (
        Client.papi_get_portfolio_interest_history.__doc__
    )
