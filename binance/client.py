...
class Client(BaseClient):
    ...
    def _klines(self, spot: HistoricalKlinesType = HistoricalKlinesType.SPOT, **params) -> Dict:
        """Get klines of spot (get_klines) or futures (futures_klines) endpoints.

        :param spot: Historical klines type: SPOT or FUTURES
        :type spot: HistoricalKlinesType
        ...
        if spot == HistoricalKlinesType.SPOT:
            return self.get_klines(**params)
        elif spot == HistoricalKlinesType.FUTURES:
            return self.futures_klines(**params)
        else:
            raise NotImplementedException(spot)

    def _get_earliest_valid_timestamp(self, symbol, interval, spot: HistoricalKlinesType = HistoricalKlinesType.SPOT):
    ...
    def get_historical_klines(self, symbol, interval, start_str, end_str=None, limit=500,
                              spot: HistoricalKlinesType = HistoricalKlinesType.SPOT):
    ...
    def futures_historical_klines(self, symbol, interval, start_str, end_str=None, limit=500):
        ...
        """
        return self._historical_klines(symbol, interval, start_str, end_str=end_str, limit=limit, spot=HistoricalKlinesType.FUTURES)
    ...
    def futures_historical_klines_generator(self, symbol, interval, start_str, end_str=None):
        ...
        return self._historical_klines_generator(symbol, interval, start_str, end_str=end_str, spot=HistoricalKlinesType.FUTURES)
...
class AsyncClient(BaseClient):
    ...
    async def _klines(self, spot: HistoricalKlinesType = HistoricalKlinesType.SPOT, **params) -> Dict:
        if 'endTime' in params and not params['endTime']:
            del params['endTime']
        if spot:
