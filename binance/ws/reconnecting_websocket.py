        ...
        try:
            while True:
                try:
                    ...
                    break
                except (asyncio.IncompleteReadError, gaierror, ConnectionClosedError, BinanceWebsocketClosed) as e:
                ...
                except (BinanceWebsocketUnableToConnect, BinanceWebsocketQueueOverflow, Exception) as e:
